...
def vgg_16_model(input_tensor=None, trainable=False):
    """
    ...
    vgg_model = VGG16(include_top = False,input_tensor = input_tensor,weights='imagenet')
    for layer in vgg_model.layers:
        layer.trainable = False
    return vgg_model.layers[-2].output
...
def classifier_layer(base_layers, input_rois, num_rois, nb_classes = 4):
    ...
    out_roi_pool = RoiPoolingConv(pooling_regions, num_rois,name='Roi1')([base_layers, input_rois])
...
output_weight_path = os.path.join(base_path, 'model/model_frcnn_vgg-keras.hdf5')

record_path = os.path.join(base_path, 'model/record1.csv') # Record data (used to save the losses, classification accuracy and mean average precision)

base_weight_path = os.path.join(base_path, './vgg16_weights_tf_dim_ordering_tf_kernels.h5')

config_output_filename = os.path.join(base_path, 'model_vgg_config-keras.pickle')
